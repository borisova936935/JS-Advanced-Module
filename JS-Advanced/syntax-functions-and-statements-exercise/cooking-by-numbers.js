function cookingByNumbers(num, p1, p2, p3, p4, p5) {
    ...
    for (let i = 0; i < arrOfCommands.length; i++) {
        ...
        switch (currentCommand) {
            case "chop": inputAsNumber = chop(inputAsNumber);
            console.log(inputAsNumber);
                break;
            case "dice": inputAsNumber = dice(inputAsNumber);
            console.log(inputAsNumber);
                break;
            case "spice": inputAsNumber = spice(inputAsNumber);
            console.log(inputAsNumber);
                break;
            case "bake": inputAsNumber = bake(inputAsNumber);
            console.log(inputAsNumber);
                break;
            case "fillet": inputAsNumber = fillet(inputAsNumber);
            console.log(inputAsNumber.toFixed(1));
                break;
        }
    }
}
